...
//}
//
//void backgroundSubtract(Mat frameA, Mat frameB, Mat morphed_diff_frame) {
//
//	Mat gray_frame1;
//	Mat gray_frame2;
//	Mat diff_frame;
//	Mat binary_diff_frame;
//
//	imshow("LIVE 1", frameA);
//	imshow("LIVE 2", frameB);
//
//	cvtColor(frameA, gray_frame1, CV_BGR2GRAY);
//	cvtColor(frameB, gray_frame2, CV_BGR2GRAY);
//
//	imshow("BACKGROUND SUB 1", gray_frame1);
//	imshow("BACKGROUND SUB 2", gray_frame2);
//
...
//	erode(morphed_diff_frame, morphed_diff_frame, getStructuringElement(MORPH_ELLIPSE, Size(3, 3)));
//
//	imshow("BACKGROUND SUBTRACTION 2", morphed_diff_frame);
//}
//
//int main() {
//
//	CvCapture* camera = cvCaptureFromFile("http://root:root@192.168.42.173/axis-cgi/mjpg/video.cgi?resolution=640x480&req_fps=30&.mjpg");
//	IplImage* back;
//	IplImage* back2;
//
//	Mat bg;
